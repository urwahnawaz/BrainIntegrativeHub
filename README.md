...
| BrainSpan  | Samples collected and analyzed by Kang et al across multiple brain structures including 11 neocortical areas, cerebellar cortex, mediodorsal nucleus of the thalamus, striatum, amygdala, and hippocampus. Samples included prenatal (age < 0; range, 8 to 38 post-conception weeks) and postnatal (age ≥ 4 mos ; range, 4 mos to 41 years) phenotypes of the normal human brain   | 524  | [BrainSpan Developmental Atlas](https://www.brainspan.org/static/download.html) <br><br> Expression matrix and metadata <br> RNA-Seq Gencode v10 summarized to genes <br><br> Additional metadata information <br> [Allen Brain Atlas](https://help.brain-map.org/display/devhumanbrain/Documentation) <br> https://help.brain-map.org/download/attachments/3506181/Human_Brain_Seq_Stages.pdf?version=1&modificationDate=1433436980032&api=v2 <br><br> mRIN: <br> Feng et al (2015)|
| GTEx  | The Genotype-Tissue Expression database contains 2,642 samples of the human postmortem brain in postnatal ages (age <20; range 20 to 79 years across 13 brain regions. All samples have been collected from non-diseased individuals   | 2642  | [GTEx v8](https://gtexportal.org/home/datasets) <br><br> Expression matrix <br> GTEx_Analysis_2017-06-05_v8_RNASeQCv1.1.9_gene_tpm.gct.gz <br> <br> Metadata files <br> GTEx_Analysis_v8_Annotations_SubjectPhenotypesDS.txt <br> GTEx_Analysis_v8_Annotations_SampleAttributesDS.txt |
...
| Velmeshev et al  | Velmeshev et al generated single-nuclei from 48 post-mortem tissue samples from the prefrontal cortex, anterior cingulate and insular cortical regions. Donors included 16 control subjects and 11 patients with ASD. All samples are postnatal  | 81,216 | Cells UCSC <br> https://cells.ucsc.edu/?ds=autism <br> <br> Matrix: <br> exprMatrix.tsv.gz <br> Values in matrix are: 10x UMI counts from cellranger, log2-transformed <br><br> Raw count matrix: <br> rawMatrix.zip <br><br> Matrix with raw read counts, includes a copy of the meta data <br><br> Cell meta annotations: <br> meta.tsv |
